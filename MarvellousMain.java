    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if (ae.getSource() == SUBMIT) 
        {
            if(Validate(value1,value2)==false)
            {
              text1.setText("");
              text2.setText("");
            JOptionPane.showMessageDialog(this,"Short username", "Marvellous Packer Unpacer", JOptionPane.ERROR_MESSAGE);   
            }    
        ...
        else
        {
            ...
            //JOptionPane.showMessageDialog(this,"Incorrect login or password    Enter the valid username and password","Error",JOptionPane.ERROR_MASSAGE);
