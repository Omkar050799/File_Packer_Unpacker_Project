...
public class MarvellousPackFront extends Template implements ActionListener
{
    ...
    public MarvellousPackFront()  //Constructor
    {
        ...
        text1.setBounds(550,50,tsize.width,tsize.height);
        ...
        text2.setBounds(550,100,tsize.width,tsize.height);
        ...
        public void actionPerformed(ActionEvent ae)
        {
            ...
            if(ae.getSource() == SUBMIT)
            {
                try
                {
                    MarvellousPack obj = new MarvellousPack(text1.getText(),text2.getText());
                    this.dispose();
